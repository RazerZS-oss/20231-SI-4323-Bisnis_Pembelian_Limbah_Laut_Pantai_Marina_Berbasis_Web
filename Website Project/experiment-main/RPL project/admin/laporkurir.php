...
if (isset($_POST['kirim'])) {
    ...
    // Query untuk menyimpan data laporan kurir ke tabel "tb_kurir"
    $query = "INSERT INTO tb_kurir (namap, nikk, notelpn, alamat, jenis, bayar, bobot, totalharga) VALUES ('$namap', '$nikk', '$notelpn', '$alamat', '$jenis', '$bayar', '$bobot', '$totalharga')";
    if (mysqli_query($conn, $query)) {
        echo "Data berhasil disimpan ke tabel tb_kurir.";
    } else {
...
<head>
    ...
    <title>Form Laporan Kurir</title>
...
<div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
      <ul class="nav flex-column ml-3 mb-5">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="#"><i class="bi bi-box-seam-fill"></i> Form Laporan Kurir</a>
        </li>
        <li class="nav-item">
                                ...
                                <div class="row m-0">
                                    <div class="col-md-12 p-0 pt-4 p-4 m-auto">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <input type="text" class="form-control" name="namap" id="namap"
                                                           required placeholder="Nama Panjang">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <input type="text" class="form-control" name="nikk" id="nikk"
                                                           required placeholder="NIK">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <input type="text" class="form-control" name="notelpn"
                                                           id="notelpn" required placeholder="Nomer Telepon">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <input type="text" class="form-control" name="bobot" id="bobot"
                                                           required placeholder="Bobot(kg)">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <input type="text" class="form-control" name="totalharga"
                                                           id="totalharga" required placeholder="total harga">
                                                </div>
                                            </div>
                                            <!-- tombol Section -->
                                            <div class="tombol">
